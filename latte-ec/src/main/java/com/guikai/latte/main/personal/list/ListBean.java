...
public class ListBean implements MultiItemEntity {
    ...
    public ListBean(int mItemType, String mImageUrl, String mText, String mValue,
                    int mId, LatteFragment mFragment, CompoundButton.OnCheckedChangeListener mOnCheckedChangeListener) {
